...
<li><a href="${pageContext.request.contextPath}/FacultyDashboardServlet">Faculty Dashboard</a></li>
...
<li><a href="${pageContext.request.contextPath}/ViewAnnouncementsServlet">View Announcements</a></li>