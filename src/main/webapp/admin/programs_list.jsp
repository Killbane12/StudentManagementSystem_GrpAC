...
<div class="container main-content">
    ...
    <a href="${pageContext.request.contextPath}/ManageProgramsServlet?action=add" class="button button-add">Add New
                                                                                                            Program</a>
    <table class="data-table">
        ...
        <c:forEach var="prog" items="${programList}"> <%-- programList set by servlet --%>
            <tr>
                ...
                <td><c:out value="${prog.departmentName}"/></td>
                    <%-- Assuming Program object has departmentName --%>
                ...
                <td class="actions">
                    ...
                    <a href="${pageContext.request.contextPath}/ManageProgramsServlet?action=delete&id=${prog.programId}"
                       class="delete"
