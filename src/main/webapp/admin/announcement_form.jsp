...
<head>
    <meta charset="UTF-8">
    <title>${empty announcement.announcementId ? 'Add New' : 'Edit'} Announcement | Student Management System -
                                                                     Group_AC</title>
    ...
    <form action="${pageContext.request.contextPath}/ManageAnnouncementsServlet" method="post">
        ...
        <div class="form-group">
            ...
            <select id="targetRole" name="targetRole" required>
                <option value="ALL" ${announcement.targetRole == 'ALL' ? 'selected' : (empty announcement.targetRole ? 'selected' : '')}>
                    ALL
                </option>
        ...
        <div class="form-group">
            ...
            <input type="date" id="expiryDate" name="expiryDate"
                   value="${DateFormatter.sqlDateToString(announcement.expiryDate)}">
        </div>
        ...
        <div class="form-actions">
            <button type="submit"
                    class="button">${empty announcement.announcementId ? 'Create Announcement' : 'Update Announcement'}</button>
            <a href="${pageContext.request.contextPath}/ManageAnnouncementsServlet?action=list"
