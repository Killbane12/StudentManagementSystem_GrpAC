...
<div class="container main-content">
    ...
    <a href="${pageContext.request.contextPath}/ManageDepartmentsServlet?action=add" class="button button-add">Add New
                                                                                                               Department</a>
        ...
        <c:forEach var="dept" items="${departmentList}">
            <tr>
                ...
                <td class="actions">
                    ...
                    <a href="${pageContext.request.contextPath}/ManageDepartmentsServlet?action=delete&id=${dept.departmentId}"
                       class="delete"
