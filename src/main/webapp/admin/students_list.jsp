...
<div class="container main-content">
    ...
    <a href="${pageContext.request.contextPath}/ManageStudentsServlet?action=add" class="button button-add">Add New Student</a>
    <table class="data-table">
        ...
        <c:forEach var="student" items="${studentList}"> <%-- From ManageStudentsServlet --%>
            <tr>
                ...
                <td>
                    <c:set var="userForStatus" value="${userListForStatus[student.userId]}"/> <%-- Assuming userListForStatus Map<Integer, User> passed from servlet --%>
                    <c:choose>
                ...
                <td class="actions">
                    <a href="${pageContext.request.contextPath}/ManageStudentsServlet?action=edit&id=${student.studentId}">Edit Profile</a>
                    <c:if test="${not empty student.userId}">
                        <a href="${pageContext.request.contextPath}/ManageUsersServlet?action=edit&userId=${student.userId}" title="Edit linked user account (email, password, status)">Edit User</a>
                    </c:if>
                    <a href="${pageContext.request.contextPath}/ManageStudentsServlet?action=delete&id=${student.studentId}" class="delete"
